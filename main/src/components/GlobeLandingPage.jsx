  ...
  return (
    <div className="h-screen bg-black relative overflow-hidden">
      ...
      <div className="absolute top-6 right-6 z-10">
        {isLoading ? (
          <div className="bg-transparent text-white font-semibold py-2 px-4 rounded-lg border border-white flex items-center space-x-2">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center space-x-2"
              style={{ 
                fontFamily: 'system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif',
                fontWeight: '600'
              }}
